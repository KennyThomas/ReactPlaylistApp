...
class topArtist extends React.Component {
    ...
    componentDidMount() {
        axios.get('http://ws.audioscrobbler.com/2.0/?method=chart.gettopartists&api_key=0d1afd69d8af4e8f7271690adf77b635&format=json') //Top artist Api
            .then((response) => {
